...
export default function ContactUs() {
  ...
  return (
    <>
      <div className="relative overflow-hidden bg-cover bg-no-repeat bg-[%] h-[400px] bg-[url('https://e0.pxfuel.com/wallpapers/174/368/desktop-wallpaper-contact-contact-us.jpg')]">
