    ...
    <section className="mt-14 pb-8">
      ...
      <div className="bg-white ">
        ...
        <Marquee direction="right" speed={50} delay={5}>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img1} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img2} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img3} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img4} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img5} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img6} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img7} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img8} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img9} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img10} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img11} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img12} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img13} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-48 h-48 " src={img14} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img15} alt="" />{" "}
          </div>
          <div className="w-50 h-48 mx-4 my-1 flex items-center justify-center">
            {" "}
            <img className="w-52 h-32 " src={img16} alt="" />{" "}
          </div>
        </Marquee>
