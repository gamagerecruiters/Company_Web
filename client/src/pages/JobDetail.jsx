    ...
    <div className="container mx-auto">
      <div className="w-full flex flex-col md:flex-row gap-10">
        ...
        {isFetching ? (
          ...
          <div className="w-full h-fit md:w-5/6 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
            ...
            <div className="w-full flex flex-wrap md:flex-row gap-1 items-center justify-between my-1 p-12">
