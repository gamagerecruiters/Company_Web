                    ...
                    <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-white">
                        <div className="flex flex-wrap items-center">
                            <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-4/12 xl:w-2/12">
                                <img src="https://vietadsgroup.vn/manager/uploads/post/founder-la-gi-tim-hieu-ve-founder-la-gi-.png"
                            ...
                            <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12 xl:w-10/12 ">
                                <div className="px-6 py-12 md:px-12">
                                    ...
                                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        ...
                                        <p className="mb-3 text-gray-900 dark:text-gray-900">
                                            This proclamation of success is underscored by our ability to become not just service providers but trusted advisors,
                                            establishing a symbiotic relationship that transcends conventional norms. Across diverse sectors, both locally and
                                            internationally, we have played a pivotal role.</p>
                                    </div>
                                    <p className="mb-3 text-gray-900 dark:text-gray-900">
                                    ...
                                    <div>
                                        ...
                                        <p className="mb-4 flex items-center justify-center md:justify-start">
                                            <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-3 h-5 w-5">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                <g id="SVGRepo_iconCarrier"> <path d="M12 1C8.96243 1 6.5 3.46243 6.5 6.5C6.5 9.53757 8.96243 12 12 12C15.0376 12 17.5 9.53757 17.5 6.5C17.5 3.46243 15.0376 1 12 1Z" fill="#000000"></path>
                                        ...
                                        <p className="mb-4 flex items-center justify-center md:justify-start">
                                            <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 950 950" xml:space="preserve" className="mr-3 h-5 w-5">
                                        ...
                                        <p className="mb-4 flex items-center justify-center md:justify-start">
                                            ...
                                            <a href="harshana@gamagerecruiters.com">harshana@gamagerecruiters.com</a>
