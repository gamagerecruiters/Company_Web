  ...
  return (
    <div className='container mb-48 mt-2 mx-auto p-5'>
      <div className=''>
        ...
        <p className='flex gap-1 items-center mt-5  px-3 py-1 text-slate-600 rounded-full'>
        ...
        {/* <div className='flex gap-1 items-center mt-5 px-3 py-1 text-slate-600 rounded-full'>
          <span className='text-xl text-blue-600'>{info?.jobPosts?.length}</span>
